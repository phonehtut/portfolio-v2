...
const testimonials = [
  {
    quote:
      "Phone Htut Khaung is one of the most talented engineers I've worked with. His attention to detail and ability to translate complex requirements into elegant solutions is remarkable.",
    author: "Pyae Sone",
